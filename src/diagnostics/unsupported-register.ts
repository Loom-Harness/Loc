...
export const UNSUPPORTED_REGISTER: readonly UnsupportedEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    kind: "gap",
    site: "src/ir/validate/checks/workflow-checks.ts:412",
    what:
  ...
  },
  {
    ...
    kind: "scope",
    site: "src/ir/validate/checks/workflow-checks.ts:1037",
  ...
  },
  {
    ...
    kind: "scope",
    site: "src/ir/validate/checks/workflow-checks.ts:1050",
