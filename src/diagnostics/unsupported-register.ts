...
export const UNSUPPORTED_REGISTER: readonly UnsupportedEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    kind: "gap",
    site: "src/ir/validate/checks/workflow-checks.ts:315",
    what:
  ...
  },
  {
    ...
    kind: "scope",
    site: "src/ir/validate/checks/workflow-checks.ts:1102",
  ...
  },
  {
    ...
    kind: "scope",
    site: "src/ir/validate/checks/workflow-checks.ts:1115",
