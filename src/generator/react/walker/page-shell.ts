...
export function renderUserComponentFile(
  ...
  const moduleDecls = (hoistedModuleDecls ?? []).join("\n");
  return `// Auto-generated.  Do not edit by hand.
${gate.import}${reactImport}${reactTypesImport}${reactRouterImport}${mantineImport}${apiHookImports}${dtoImportLines}${actionWiring.imports}${store.imports}${toastImport}${userComponentImports}${externFunctionImports}${propsType}${form.moduleScope}${moduleDecls === "" ? "" : `${moduleDecls}\n`}
