...
export type LooseName = 'aggregates' | 'allow' | 'api' | 'await' | 'bind' | 'cache' | 'component' | 'contains' | 'contexts' | 'deep' | 'deny' | 'design' | 'directoryLayout' | 'framework' | 'from' | 'global' | 'id' | 'ignoring' | 'link' | 'local' | 'menu' | 'modules' | 'of' | 'page' | 'permissions' | 'persistence' | 'policy' | 'route' | 'section' | 'static' | 'targets' | 'transactional' | 'ui' | 'urlStyle' | 'views' | 'workflows' | CommonSoftKeywords | string;

export function isLooseName(item: unknown): item is LooseName {
    return isCommonSoftKeywords(item) || item === 'aggregates' || item === 'allow' || item === 'api' || item === 'await' || item === 'bind' || item === 'cache' || item === 'component' || item === 'contains' || item === 'contexts' || item === 'deep' || item === 'deny' || item === 'design' || item === 'directoryLayout' || item === 'framework' || item === 'from' || item === 'global' || item === 'id' || item === 'ignoring' || item === 'link' || item === 'local' || item === 'menu' || item === 'modules' || item === 'of' || item === 'page' || item === 'permissions' || item === 'persistence' || item === 'policy' || item === 'route' || item === 'section' || item === 'static' || item === 'targets' || item === 'transactional' || item === 'ui' || item === 'urlStyle' || item === 'views' || item === 'workflows' || (typeof item === 'string' && (/[_a-zA-Z][\w_]*/.test(item)));
}
