...
export interface AssignOrCallStmt extends langium.AstNode {
    readonly $container: ActionDecl | Apply | CommandHandler | Create | Destroy | DomainServiceOperation | ForStmt | FunctionDecl | HandleDecl | IfLetStmt | IfStmt | Lambda | MatchStmt | OnDecl | Operation | ProjectionOn | QueryHandler | StampDecl | TestBlock | TestE2E | UiNotification | VariantStmtArm | WorkflowCreateDecl;
...
export interface AwaitExpr extends langium.AstNode {
    readonly $container: ActionDecl | Apply | AssignOrCallStmt | AwaitExpr | BinaryChain | BodyProp | BuilderEntry | CallArg | ColumnStep | CommandHandler | Component | Create | Criterion | DerivedProp | Destroy | DomainServiceOperation | EmitField | ExpectStmt | FilterDecl | FindDecl | ForStmt | FunctionDecl | HandleDecl | IfLetStmt | IfStmt | Invariant | LValue | Lambda | LayoutNamedSlot | LetStmt | ListLit | MatchArm | MatchExpr | MatchStmt | MenuLinkProp | MenuMetaEntry | ObjectFieldInit | OnDecl | Operation | Parameter | ParenExpr | PolicyDecl | PostfixChain | PreconditionStmt | PrimitiveConversion | Projection | ProjectionJoin | ProjectionOn | ProjectionSelect | Property | QueryHandler | RequirementProp | RequiresProp | RequiresStmt | Retrieval | RetrievalLiteral | ReturnStmt | StateField | TemplateHole | TernaryExpr | TitleProp | UnaryExpr | VariantArm | Workflow | WorkflowCreateDecl;
...
export type ContextMember = Aggregate | Channel | CommandHandler | Criterion | DomainService | EnumDecl | EventDecl | FilterDecl | ImplementsDecl | PayloadDecl | PolicyDecl | Projection | QueryHandler | Repository | Retrieval | Seed | StampDecl | TestBlock | ValueObject | Workflow;
...
export interface Deployable extends langium.AstNode {
    ...
    auth?: AuthMode;
    channelRefs: Array<langium.Reference<ChannelSource>>;
...
export interface ForStmt extends langium.AstNode {
    readonly $container: ActionDecl | Apply | CommandHandler | Create | Destroy | DomainServiceOperation | ForStmt | FunctionDecl | HandleDecl | IfLetStmt | IfStmt | Lambda | MatchStmt | OnDecl | Operation | ProjectionOn | QueryHandler | VariantStmtArm | WorkflowCreateDecl;
...
export interface Migration extends langium.AstNode {
    readonly $container: Model;
...
export type NameRefIdent = 'aggregates' | 'api' | 'bind' | 'cache' | 'component' | 'contains' | 'contexts' | 'create' | 'design' | 'destroy' | 'framework' | 'ignoring' | 'link' | 'menu' | 'modules' | 'page' | 'permissions' | 'route' | 'section' | 'static' | 'targets' | 'ui' | 'urlStyle' | 'views' | 'workflows' | CommonSoftKeywords | string;

export function isNameRefIdent(item: unknown): item is NameRefIdent {
    return isCommonSoftKeywords(item) || item === 'aggregates' || item === 'api' || item === 'bind' || item === 'cache' || item === 'component' || item === 'contains' || item === 'contexts' || item === 'create' || item === 'design' || item === 'destroy' || item === 'framework' || item === 'ignoring' || item === 'link' || item === 'menu' || item === 'modules' || item === 'page' || item === 'permissions' || item === 'route' || item === 'section' || item === 'static' || item === 'targets' || item === 'ui' || item === 'urlStyle' || item === 'views' || item === 'workflows' || (typeof item === 'string' && (/[_a-zA-Z][\w_]*/.test(item)));
}
...
export interface ObjectLit extends langium.AstNode {
    readonly $container: ActionDecl | Apply | AssignOrCallStmt | AwaitExpr | BinaryChain | BodyProp | BuilderEntry | CallArg | ColumnStep | CommandHandler | Component | Create | Criterion | DerivedProp | Destroy | DomainServiceOperation | EmitField | ExpectStmt | FilterDecl | FindDecl | ForStmt | FunctionDecl | HandleDecl | IfLetStmt | IfStmt | Invariant | LValue | Lambda | LayoutNamedSlot | LetStmt | ListLit | MatchArm | MatchExpr | MatchStmt | MenuLinkProp | MenuMetaEntry | ObjectFieldInit | OnDecl | Operation | Parameter | ParenExpr | PolicyDecl | PostfixChain | PreconditionStmt | PrimitiveConversion | Projection | ProjectionJoin | ProjectionOn | ProjectionSelect | Property | QueryHandler | RequirementProp | RequiresProp | RequiresStmt | Retrieval | RetrievalLiteral | ReturnStmt | SeedRow | StateField | TemplateHole | TernaryExpr | TitleProp | UnaryExpr | VariantArm | Workflow | WorkflowCreateDecl;
...
export interface Parameter extends langium.AstNode {
    readonly $container: ActionDecl | CommandHandler | Component | Create | Criterion | Destroy | DomainServiceOperation | FindDecl | FunctionDecl | HandleDecl | Operation | Page | PolicyDecl | Projection | QueryHandler | Retrieval | UiFunction | WorkflowCreateDecl;
...
export interface ProjectionJoin extends langium.AstNode {
    readonly $container: Projection;
    readonly $type: 'ProjectionJoin';
    aggregate: langium.Reference<Aggregate>;
    alias: string;
    idRef: Expression;
}

export const ProjectionJoin = {
    $type: 'ProjectionJoin',
    aggregate: 'aggregate',
    alias: 'alias',
    idRef: 'idRef'
...
export function isProjectionJoin(item: unknown): item is ProjectionJoin {
    return reflection.isInstance(item, ProjectionJoin.$type);
}
...
export interface ProjectionSelect extends langium.AstNode {
    readonly $container: Projection;
    readonly $type: 'ProjectionSelect';
    expr: Expression;
    field: LooseName;
}
...
export interface Property extends langium.AstNode {
    readonly $container: Aggregate | Capability | EntityPart | EventDecl | PayloadDecl | Projection | ValueObject | Workflow;
...
export type Statement = AssignOrCallStmt | EmitStmt | ForStmt | IfLetStmt | IfStmt | LetStmt | MatchStmt | PreconditionStmt | RequiresStmt | ReturnStmt;
...
export type Targetable = Aggregate | Api | BoundedContext | Deployable | EventDecl | Operation | Repository | Subdomain | ValueObject | Workflow;
...
export interface TemplateHole extends langium.AstNode {
    readonly $container: TemplateStr;
    readonly $type: 'TemplateHole';
    format?: string;
    value: Expression;
}

export const TemplateHole = {
    $type: 'TemplateHole',
    format: 'format',
    value: 'value'
} as const;

export function isTemplateHole(item: unknown): item is TemplateHole {
    return reflection.isInstance(item, TemplateHole.$type);
}

export interface TemplateStr extends langium.AstNode {
    readonly $container: ActionDecl | Apply | AssignOrCallStmt | AwaitExpr | BinaryChain | BodyProp | BuilderEntry | CallArg | ColumnStep | CommandHandler | Component | Create | Criterion | DerivedProp | Destroy | DomainServiceOperation | EmitField | ExpectStmt | FilterDecl | FindDecl | ForStmt | FunctionDecl | HandleDecl | IfLetStmt | IfStmt | Invariant | LValue | Lambda | LayoutNamedSlot | LetStmt | ListLit | MatchArm | MatchExpr | MatchStmt | MenuLinkProp | MenuMetaEntry | ObjectFieldInit | OnDecl | Operation | Parameter | ParenExpr | PolicyDecl | PostfixChain | PreconditionStmt | PrimitiveConversion | Projection | ProjectionJoin | ProjectionOn | ProjectionSelect | Property | QueryHandler | RequirementProp | RequiresProp | RequiresStmt | Retrieval | RetrievalLiteral | ReturnStmt | StateField | TemplateHole | TernaryExpr | TitleProp | UnaryExpr | VariantArm | Workflow | WorkflowCreateDecl;
    readonly $type: 'TemplateStr';
    holes: Array<TemplateHole>;
...
export type UserFieldName = 'id' | 'migration' | 'permissions' | string;

export function isUserFieldName(item: unknown): item is UserFieldName {
    return item === 'id' || item === 'permissions' || item === 'migration' || (typeof item === 'string' && (/[_a-zA-Z][\w_]*/.test(item)));
}
...
export class DddAstReflection extends langium.AbstractAstReflection {
    override readonly types = {
        ActionDecl: {
            ...
            properties: {
                audited: {
                    name: ActionDecl.audited,
                    defaultValue: false,
                    optional: true
                },
                extern: {
                    name: ActionDecl.extern,
                    defaultValue: false,
                    optional: true
                },
                gate: {
                    name: ActionDecl.gate,
                    optional: true
                },
                name: {
        ...
        Deployable: {
            ...
            properties: {
                ...
                channelRefs: {
                    name: Deployable.channelRefs,
                    defaultValue: [],
                    referenceType: ChannelSource.$type,
                    optional: true
                },
                contextRefs: {
        ...
        DomainServiceOperation: {
            ...
            properties: {
                audited: {
                    name: DomainServiceOperation.audited,
                    defaultValue: false,
                    optional: true
                },
                extern: {
                    name: DomainServiceOperation.extern,
                    defaultValue: false,
                    optional: true
                },
                gate: {
                    name: DomainServiceOperation.gate,
                    optional: true
                },
                name: {
                ...
                private: {
                    name: DomainServiceOperation.private,
                    defaultValue: false,
                    optional: true
                },
                returnType: {
                ...
                when: {
                    name: DomainServiceOperation.when,
                    optional: true
                }
            },
            superTypes: []
        ...
        FunctionDecl: {
            ...
            properties: {
                ...
                extern: {
                    name: FunctionDecl.extern,
                    defaultValue: false,
                    optional: true
                },
                gate: {
                    name: FunctionDecl.gate,
                    optional: true
                },
                name: {
        ...
        HandleDecl: {
            ...
            properties: {
                ...
                extern: {
                    name: HandleDecl.extern,
                    defaultValue: false,
                    optional: true
                },
                gate: {
                    name: HandleDecl.gate,
                    optional: true
                },
                name: {
                ...
                private: {
                    name: HandleDecl.private,
                    defaultValue: false,
                    optional: true
                },
                when: {
                    name: HandleDecl.when,
                    optional: true
                }
            },
        ...
        ProjectionJoin: {
            ...
            properties: {
                aggregate: {
                    name: ProjectionJoin.aggregate,
                    referenceType: Aggregate.$type
                },
                alias: {
                    name: ProjectionJoin.alias
                },
                idRef: {
                    name: ProjectionJoin.idRef
                }
            },
            superTypes: []
        },
        ...
        ProjectionSelect: {
            name: ProjectionSelect.$type,
            properties: {
                expr: {
                    name: ProjectionSelect.expr
                },
                field: {
        ...
        TemplateHole: {
            name: TemplateHole.$type,
            properties: {
                format: {
                    name: TemplateHole.format,
                    optional: true
                },
                value: {
                    name: TemplateHole.value
                }
            },
            superTypes: []
        },
        ...
        WorkflowCreateDecl: {
            ...
            properties: {
                audited: {
                    name: WorkflowCreateDecl.audited,
                    defaultValue: false,
                    optional: true
                },
                body: {
                ...
                extern: {
                    name: WorkflowCreateDecl.extern,
                    defaultValue: false,
                    optional: true
                },
                gate: {
                    name: WorkflowCreateDecl.gate,
                    optional: true
                },
                name: {
