...
export type LooseName = 'aggregates' | 'api' | 'await' | 'bind' | 'cache' | 'component' | 'contains' | 'contexts' | 'design' | 'directoryLayout' | 'framework' | 'from' | 'id' | 'ignoring' | 'link' | 'local' | 'menu' | 'modules' | 'page' | 'permissions' | 'route' | 'section' | 'static' | 'targets' | 'transactional' | 'ui' | 'urlStyle' | 'views' | 'workflows' | CommonSoftKeywords | string;

export function isLooseName(item: unknown): item is LooseName {
    return isCommonSoftKeywords(item) || item === 'aggregates' || item === 'api' || item === 'await' || item === 'bind' || item === 'cache' || item === 'component' || item === 'contains' || item === 'contexts' || item === 'design' || item === 'directoryLayout' || item === 'framework' || item === 'from' || item === 'id' || item === 'ignoring' || item === 'link' || item === 'local' || item === 'menu' || item === 'modules' || item === 'page' || item === 'permissions' || item === 'route' || item === 'section' || item === 'static' || item === 'targets' || item === 'transactional' || item === 'ui' || item === 'urlStyle' || item === 'views' || item === 'workflows' || (typeof item === 'string' && (/[_a-zA-Z][\w_]*/.test(item)));
}
