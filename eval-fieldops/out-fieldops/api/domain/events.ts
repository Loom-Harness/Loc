...
export interface WorkOrderCompleted {
  readonly type: "WorkOrderCompleted";
  readonly workOrder: Ids.WorkOrderId;
  readonly at: Date;
  readonly org: string;
}

export interface WorkOrderScheduled {
  readonly type: "WorkOrderScheduled";
  readonly workOrder: Ids.WorkOrderId;
  readonly technician: Ids.TechnicianId;
  readonly at: Date;
}

export type DomainEvent = WorkOrderCompleted | WorkOrderScheduled;
