...
test("ScheduleWorkOrderWorkflow loads", async ({ page }) => {
  await page.goto("/workflows/schedule_work_order");
  await expect(page).toHaveURL(new RegExp("/workflows/schedule_work_order$"));
});
