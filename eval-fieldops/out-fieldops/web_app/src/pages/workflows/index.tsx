...
export default function WorkflowsIndex() {
  return (
    <Stack gap="md" data-testid="workflows-index">
      ...
      <Stack gap="md">
        <Card withBorder padding="md" data-testid="workflow-card-schedule_work_order">
          <Title order={4}>{t("page.WorkflowsIndex.heading.len7l1", "Schedule Work Order")}</Title>
          <Anchor component={RouterLink} to="/workflows/schedule_work_order" data-testid="workflow-schedule_work_order-run">{t("page.WorkflowsIndex.anchor.5fm2dg", "Run →")}</Anchor>
        </Card>
      </Stack>
    </Stack>
  );
