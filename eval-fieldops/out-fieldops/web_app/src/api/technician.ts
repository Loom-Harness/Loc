...
export const SkillSchema = z.enum(["Electrical", "Plumbing", "HVAC", "Refrigeration"]);
...
export type CreateTechnicianFormState = z.input<typeof CreateTechnicianRequest>;
/** Post-parse payload shape (z.output) — money fields are Decimal. */
export type CreateTechnicianPayload = z.output<typeof CreateTechnicianRequest>;
...
/** Pre-parse form shape (z.input) — money fields are decimal strings. */
export type UpdateTechnicianFormState = z.input<typeof UpdateTechnicianRequest>;
/** Post-parse payload shape (z.output) — money fields are Decimal. */
export type UpdateTechnicianPayload = z.output<typeof UpdateTechnicianRequest>;
