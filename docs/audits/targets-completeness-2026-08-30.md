...
| P4 | 79 |
| P5 | 9 |
| kind: silent / honest / breadth / mission / stale-prose | 17 / 34 / 21 / 58 / 9 |
| confidence: proven / likely / suspected | 27 / 111 / 1 |
| class: faulty-fix / regression | 1 / 0 |
| size S / M / L | 36 / 60 / 43 |
| provenance: fleet1-only / fleet2-only / corroborated by both | 123 / 14 / 1 |
