...
Live = every heading that is not closed (`open` 66 · `partial` 65 · `blocked` 4 · `plan` 1 · `deferred` 1 · `recurring` 2 · `frozen` 7 · `mostly done` 1 · `in progress` 1 — 148 headings in all, 2026-09-10 count; regenerate with `grep -c '^## M-T' docs/new-plan/T*.md`). *The 2026-09-03 jump is the [language-docs audit](../audits/2026-09-03-language-docs-audit-findings.md): 18 missions minted from its 47 findings — M-T5.26–M-T5.29, M-T1.28–M-T1.31, M-T6.53–M-T6.58, M-T9.44–M-T9.47, one per packet of its [wave plan](../audits/2026-09-03-language-docs-audit-findings.waves.md). **Waves 1, 2 and 4 of that plan are drained** (2026-09-09/10): M-T1.28–M-T1.30, M-T5.26, M-T5.27, M-T5.29, M-T6.53, M-T9.44 and M-T9.45 are archived. What remains from it is W3.1 (M-T5.28), Wave 5 (M-T6.54–M-T6.57), Wave 6 (M-T6.58) and Wave 7 (M-T9.46, M-T9.47) — all `open`.*
