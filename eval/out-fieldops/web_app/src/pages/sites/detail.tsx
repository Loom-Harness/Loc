  ...
  return (
    ...
    >
      <Stack>
        ...
        <TextInput label="City" {...register("city")} data-testid="sites-op-update-input-city" error={errors.city?.message} />
          ...
          <Stack gap="md">
            <Card withBorder padding="md">
              <Stack gap="md">
                ...
                <KeyValueRow label={t("page.Detail.keyValue.42k4ma", "City")} data-testid="sites-detail-city"><Text>{siteById.data.city}</Text></KeyValueRow>
