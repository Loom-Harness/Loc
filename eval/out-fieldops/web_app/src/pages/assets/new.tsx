      ...
      <Card withBorder padding="md">
        <form onSubmit={handleSubmit(async (vals) => {
          ...
          <Stack gap="md">
            ...
            <TextInput label="Required Skill" {...register("requiredSkill")} data-testid="assets-new-input-requiredSkill" error={errors.requiredSkill?.message} />
            ...
            <TextInput label="Warranty Expiry" {...register("warrantyExpiry")} data-testid="assets-new-input-warrantyExpiry" type="datetime-local" error={errors.warrantyExpiry?.message} />
