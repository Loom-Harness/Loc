...
export const CHANNEL_BINDINGS = [
  { csName: "lifecycleBus", address: "loom.Dispatch.Lifecycle", envVar: "LOOM_CHANNEL_LIFECYCLE_BUS_URL", context: "Dispatch", transport: "redis", group: "loom.Dispatch.Lifecycle.api", queue: false },
] as const;
