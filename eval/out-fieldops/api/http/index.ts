...
import { SiteRepository } from "../db/repositories/site-repository";
...
import { dispatchPhotos$getBytes, dispatchPhotos$putBytes } from "../resources/localDisk";
...
export function createApp(
  ...
  // File upload — multipart POST, stores raw bytes in the 'dispatchPhotos' object store,
  ...
  app.post("/files", async (c) => {
    ...
    await dispatchPhotos$putBytes(key, bytes, contentType);
