...
export const CHANNEL_BINDINGS = [
  { csName: "lifecycleBus", address: "loom.Dispatch.Lifecycle", envVar: "LOOM_CHANNEL_LIFECYCLE_BUS_URL", context: "Dispatch", transport: "redis", group: "loom.Dispatch.Lifecycle.notifier", queue: false },
] as const;
...
export const CHANNEL_ROUTING: Record<string, string> = {
  WorkOrderCompleted: "loom.Dispatch.Lifecycle",
};
